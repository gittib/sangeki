...
$oSangeki = (object)array(
    ...
    'advice' => (object)array(
        ...
        'detail' => "本来は公開情報であるはずの不安・暗躍の数が盤面に表されないため、今どこに何個のカウンターが乗っているかは脚本家が常に秘密裏に管理しておかねばなりません。脚本家行動カードは非公開かつループ1回制限なので、一度配置したカードはループ終了まで伏せて配置されたままにしておきましょう。管理の助けになります。\n\n勝利手段は巨大時限爆弾ほぼ一択です。しかし不穏な噂と行方不明により、非常に安定して達成が可能です。患者を退院させられない限り、不安拡大と行方不明は毎回起こして下さい。\n\n余った手数でCSも頑張りましょう。異世界人だけは役職を非常に明かしにくいため、彼女がCSの中心となります。\n異世界人にカードを置けば、不安拡大の暗躍と合わせて僕と契約しようよのCSになります。また行方不明が確定で起こるので、その犯人への誤認も誘えれば封印されしものへのCSにもなります。\n\n蝶の羽ばたきの重要度は低めです。不安拡大の不安をお嬢様に乗せれば確定で起こせますが、入院患者がミスリーダーとバレる可能性に繋がるため、1ループ目以外は不安拡大の不安は入院患者へ乗せるのが無難です。\n\n主人公としてこれを防ぐには、2人のフレンドを割ることが必須条件となります。しかも割るための手段は異世界人で殺すしかないため、主人公勝利のためには最低でも2ループを捨てる事になります。\n\n幸い脚本家は友好禁止も移動カードも持っていないため、見当さえつけば遂行するのは確実にできます。",
