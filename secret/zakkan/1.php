...
<?php require(SECRET_DIR.'sangeki_head.php'); ?>
    <title>れうさんのオリジナル惨劇セット雑感 - <?= SITE_NAME ?></title>
    <link rel="canonical" href="<?= $canonicalUrl ?>">
</head>
<body class="zakkan">
<?php require(SECRET_DIR.'sangeki_header.php'); ?>
    <h2>れうさんのオリジナル惨劇セット雑感</h2>
    <time datetime="2021-11-16">2021年11月16日</time>
    <div>
        <a href="https://twitter.com/reryt/status/1454819373449842698" target="_blank">れうさんの考案されているオリジナル惨劇セット</a>が面白そうだったので、自分用のメモとして各ルール雑感をまとめてみる。
        なおエアプなので、間違いや認識違いが含まれてる可能性あります。
    </div>
    <h3>ルールY</h3>
    <dl class="tips">
        <dt>輪廻する純真</dt>
        ...
        <dt>袋小路の世界</dt>
        <dd>
            <p class="loops_for_rule">稼げるループ数：３～４</p>
            ボードへの暗躍が非常に強く、脚本家カードの手置きだけでも２ループ目くらいまで簡単にとれてしまいそう。他のルールYを採用し、袋小路の世界へのCSを弄するのも非常に強力。
            デッドエンドは死体があるほど強化されるため、殺害手段の幅広さが脚本難易度に直結する。シリアルキラーや遂行者すら脚本家有利に働きうる。<br>
            日数調整がかなりシビアな印象。殺害手段のバリエーションと合わせて、脚本作成の腕が問われる。
        </dd>
        <dt>暴虐の王</dt>
        <dd>
            <p class="loops_for_rule">稼げるループ数：１～２</p>
    ...
    <dl class="tips">
        ...
        <dt>不穏な噂</dt>
        <dd>
            <p class="loops_for_rule">稼げるループ数：０～２</p>
        ...
        <dt>世界崩壊カウントダウン</dt>
        <dd>
            <p class="loops_for_rule">稼げるループ数：０</p>
        ...
        <dt>悪性惨劇臨界点</dt>
        <dd>
            <p class="loops_for_rule">稼げるループ数：２</p>
