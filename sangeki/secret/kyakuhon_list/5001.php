...
$oSangeki = (object)array(
    ...
    'advice' => (object)array(
        ...
        'detail' => "無貌の神は可能な限り隠します。よって手先をミスリーダーと誤認させつつ、ウィザードの存在を気取られないよう立ち回りましょう。ただ、各ループでの勝利はかなり簡単にできるようになっています。\nまずEXゲージ1以下でループが開始した場合、脚本家は事件だけで確実に勝利できます。\n不安拡大を起こして入院患者に不安、異世界人に暗躍を置きましょう。フェイスレスのミスリーダー能力は必要に応じて使って下さい。翌日にテンプレに従う事で、病院と異世界人、どちらの暗躍が通ったとしても病院の事件で主人公は死亡します。\nループ開始時EXゲージ2の場合は注意が必要です。不安拡大を引き起こすため、手先の初期配置はミスリーダーいるエリアにします。\n\n最後の戦いでは、ヒトハシラかモクゲキシャを隠します。普通にループ消費ならヒトハシラの全滅能力は使って良いでしょう。逆に、発狂狙いならモクゲキシャの能力が有用です。どちらを使い、どちらを隠すかは状況に応じて判断して下さい。",
        'template' => array(
            '開始時EX 1以下' => array(
                1 => array(
                    '手先' => '不安+1',
